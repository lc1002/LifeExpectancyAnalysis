...
full_model = lm(le ~ status + adult_mort + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = le_df)
summary(full_model)
...
full_bc = lm(bc_le ~ status + adult_mort + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = le_df)
summary(full_bc)

full = lm(le ~ status + adult_mort + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = le_df)
summary(full)
...
no_influ_full_bc = lm(bc_le ~ status + adult_mort + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = no_influ_le)
...
final_full = lm(bc_le ~ status + adult_mort + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + schooling, data = no_influ_le)
...
model = train(bc_le ~ status + adult_mort + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + schooling, data = no_influ_le, trControl = train, method = 'lm', na.action = na.pass)
