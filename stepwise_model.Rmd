...
stepwise = lm(le ~ status + adult_mort + infantdeaths + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = le_df)
summary(stepwise)
...
stepwise_bc = lm(bc_le ~ status + adult_mort + infantdeaths + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = le_df)
summary(stepwise_bc)
...
no_influ_stepwise = lm(le ~ status + adult_mort + infantdeaths + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = no_influ_le)
...
model = train(le ~ status + adult_mort + infantdeaths + bmi + polio + diphtheria + hiv_aids + gdp + thin_1_19 + HDI + schooling, data = no_influ_le, trControl = train, method = 'lm', na.action = na.pass)
